...
static const PixelFormatInfoMapValue TexturePixelFormatInfoTablesValue[] = {
    PixelFormatInfoMapValue(backend::PixelFormat::BGRA8888,
                            Texture2D::PixelFormatInfo(32, false, true)),
    PixelFormatInfoMapValue(backend::PixelFormat::RGBA8888,
                            Texture2D::PixelFormatInfo(32, false, true)),
    PixelFormatInfoMapValue(backend::PixelFormat::RGBA4444,
                            Texture2D::PixelFormatInfo(16, false, true)),
    PixelFormatInfoMapValue(backend::PixelFormat::RGB5A1,
                            Texture2D::PixelFormatInfo(16, false, true)),
    PixelFormatInfoMapValue(backend::PixelFormat::RGB565,
                            Texture2D::PixelFormatInfo(16, false, false)),
    PixelFormatInfoMapValue(backend::PixelFormat::RGB888,
                            Texture2D::PixelFormatInfo(24, false, false)),
    PixelFormatInfoMapValue(backend::PixelFormat::A8,
                            Texture2D::PixelFormatInfo(8, false, false)),
    PixelFormatInfoMapValue(backend::PixelFormat::I8,
                            Texture2D::PixelFormatInfo(8, false, false)),
    PixelFormatInfoMapValue(backend::PixelFormat::AI88,
                            Texture2D::PixelFormatInfo(16, false, true)),

#if defined(GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG) || \
    (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    PixelFormatInfoMapValue(backend::PixelFormat::PVRTC2,
                            Texture2D::PixelFormatInfo(2, true, false)),
    PixelFormatInfoMapValue(backend::PixelFormat::PVRTC2A,
                            Texture2D::PixelFormatInfo(2, true, true)),
    PixelFormatInfoMapValue(backend::PixelFormat::PVRTC4,
                            Texture2D::PixelFormatInfo(4, true, false)),
    PixelFormatInfoMapValue(backend::PixelFormat::PVRTC4A,
                            Texture2D::PixelFormatInfo(4, true, true)),
#endif

#if defined(GL_ETC1_RGB8_OES) || (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    PixelFormatInfoMapValue(backend::PixelFormat::ETC,
                            Texture2D::PixelFormatInfo(4, true, false)),
#endif

#if defined(GL_COMPRESSED_RGBA_S3TC_DXT1_EXT) || \
    (CC_TARGET_PLATFORM == CC_PLATFORM_MAC)
    PixelFormatInfoMapValue(backend::PixelFormat::S3TC_DXT1,
                            Texture2D::PixelFormatInfo(4, true, false)),
#endif

#if defined(GL_COMPRESSED_RGBA_S3TC_DXT3_EXT) || \
    (CC_TARGET_PLATFORM == CC_PLATFORM_MAC)
    PixelFormatInfoMapValue(backend::PixelFormat::S3TC_DXT3,
                            Texture2D::PixelFormatInfo(8, true, false)),
#endif

#if defined(GL_COMPRESSED_RGBA_S3TC_DXT5_EXT) || \
    (CC_TARGET_PLATFORM == CC_PLATFORM_MAC)
    PixelFormatInfoMapValue(backend::PixelFormat::S3TC_DXT5,
                            Texture2D::PixelFormatInfo(8, true, false)),
#endif

#ifdef GL_ATC_RGB_AMD
    PixelFormatInfoMapValue(backend::PixelFormat::ATC_RGB,
                            Texture2D::PixelFormatInfo(4, true, false)),
#endif

#ifdef GL_ATC_RGBA_EXPLICIT_ALPHA_AMD
    PixelFormatInfoMapValue(backend::PixelFormat::ATC_EXPLICIT_ALPHA,
                            Texture2D::PixelFormatInfo(8, true, false)),
#endif

#ifdef GL_ATC_RGBA_INTERPOLATED_ALPHA_AMD
    PixelFormatInfoMapValue(backend::PixelFormat::ATC_INTERPOLATED_ALPHA,
                            Texture2D::PixelFormatInfo(8, true, false)),
#endif
// metal formats
#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    PixelFormatInfoMapValue(backend::PixelFormat::MTL_ABGR4,
                            Texture2D::PixelFormatInfo(16, false, true)),
    PixelFormatInfoMapValue(backend::PixelFormat::MTL_B5G6R5,
                            Texture2D::PixelFormatInfo(16, false, false)),
    PixelFormatInfoMapValue(backend::PixelFormat::MTL_BGR5A1,
                            Texture2D::PixelFormatInfo(16, false, true)),
#endif
};
}  // namespace
...
const Texture2D::PixelFormatInfoMap Texture2D::_pixelFormatInfoTables(
    TexturePixelFormatInfoTablesValue,
    TexturePixelFormatInfoTablesValue +
        sizeof(TexturePixelFormatInfoTablesValue) /
            sizeof(TexturePixelFormatInfoTablesValue[0]));

// If the image has alpha, you can create RGBA8 (32-bit) or RGBA4 (16-bit) or
// RGB5A1 (16-bit) Default is: RGBA8888 (32-bit textures)
static backend::PixelFormat g_defaultAlphaPixelFormat =
    backend::PixelFormat::DEFAULT;
...
Texture2D::Texture2D()
  ...
  _texture = static_cast<backend::Texture2DBackend*>(
      backend::Device::getInstance()->newTexture(textureDescriptor));
}
...
backend::PixelFormat Texture2D::getPixelFormat() const { return _pixelFormat; }
...
float Texture2D::getMaxS() const { return _maxS; }

void Texture2D::setMaxS(float maxS) { _maxS = maxS; }

float Texture2D::getMaxT() const { return _maxT; }

void Texture2D::setMaxT(float maxT) { _maxT = maxT; }

bool Texture2D::hasPremultipliedAlpha() const { return _hasPremultipliedAlpha; }

bool Texture2D::initWithData(const void* data, ssize_t dataLen,
  ...
  return initWithMipmaps(&mipmap, 1, pixelFormat, renderFormat, pixelsWide,
                         pixelsHigh, preMultipliedAlpha);
}
...
bool Texture2D::initWithMipmaps(MipmapInfo* mipmaps, int mipmapsNum,
  ...
  assert(
      pixelFormat != PixelFormat::NONE && pixelFormat != PixelFormat::AUTO, );
  assert(pixelsWide > 0 && pixelsHigh > 0);

  if (mipmapsNum <= 0) {
    printf("april3d: WARNING: mipmap number is less than 1");
    return false;
  }

  auto formatItr = _pixelFormatInfoTables.find(pixelFormat);
  if (formatItr == _pixelFormatInfoTables.end()) {
    CCLOG("april3d: WARNING: unsupported pixelformat: %lx",
  ...
  if (info.compressed && !Configuration::getInstance()->supportsPVRTC() &&
    ...
    printf("april3d: WARNING: PVRTC/ETC images are not supported");
    return false;
  }
  ...
  textureDescriptor.samplerDescriptor.magFilter =
      (_antialiasEnabled) ? backend::SamplerFilter::LINEAR
                          : backend::SamplerFilter::NEAREST;
  if (mipmapsNum == 1) {
    textureDescriptor.samplerDescriptor.minFilter =
        (_antialiasEnabled) ? backend::SamplerFilter::LINEAR
                            : backend::SamplerFilter::NEAREST;
  } else {
    textureDescriptor.samplerDescriptor.minFilter =
        (_antialiasEnabled) ? backend::SamplerFilter::LINEAR_MIPMAP_NEAREST
  ...
  for (int i = 0; i < mipmapsNum; ++i) {
    ...
    {
      auto convertedFormat = backend::PixelFormatUtils::convertDataToFormat(
          data, dataLen, oriPixelFormat, renderFormat, &outData, &outDataLen);
      if (convertedFormat == renderFormat) pixelFormat = renderFormat;
    }

    textureDescriptor.textureFormat = pixelFormat;
    CCASSERT(textureDescriptor.textureFormat != backend::PixelFormat::NONE,
             "PixelFormat should not be NONE");
    ...
    if (i > 0 && (width != height || ccNextPOT(width) != width)) {
      printf(
          "april3d: Texture2D. WARNING. Mipmap level %u is not squared. "
          "Texture won't render correctly. width=%d != height=%d",
          i, width, height);
    }
...
bool Texture2D::updateWithData(void* data, int offsetX, int offsetY, int width,
                               int height) {
...
bool Texture2D::initWithImage(Image* image, backend::PixelFormat format) {
  ...
  if (imageWidth > maxTextureSize || imageHeight > maxTextureSize) {
    CCLOG(
        "cocos2d: WARNING: Image (%u x %u) is bigger than the supported %u x "
        "%u",
  ...
  backend::PixelFormat renderFormat =
      ((PixelFormat::NONE == format) || (PixelFormat::AUTO == format))
  ...
  if (image->getNumberOfMipmaps() > 1) {
    if (renderFormat != image->getPixelFormat()) {
      CCLOG(
          "cocos2d: WARNING: This image has more than 1 mipmaps and we will "
          "not convert the data format");
    }

    // pixel format of data is not converted, renderFormat can be different from
    // pixelFormat it will be done later
    initWithMipmaps(image->getMipmaps(), image->getNumberOfMipmaps(),
                    image->getPixelFormat(), renderFormat, imageWidth,
                    imageHeight, image->hasPremultipliedAlpha());

    return true;
  } else if (image->isCompressed()) {
    if (renderFormat != image->getPixelFormat()) {
      CCLOG(
          "cocos2d: WARNING: This image is compressed and we can't convert it "
          "for now");
    }

    initWithData(tempData, tempDataLen, image->getPixelFormat(), imageWidth,
                 imageHeight, imageSize, image->hasPremultipliedAlpha());

    return true;
  } else {
    // after conversion, renderFormat == pixelFormat of data
    initWithData(tempData, tempDataLen, imagePixelFormat, renderFormat,
...
bool Texture2D::initWithString(
    const char* text, const std::string& fontName, float fontSize,
...
bool Texture2D::initWithString(const char* text,
  ...
  if (TextVAlignment::TOP == textDefinition._vertAlignment) {
    ...
    (CC_TARGET_PLATFORM != CC_PLATFORM_IOS)
  CCASSERT(textDefinition._stroke._strokeEnabled == false,
           "Currently stroke only supported on iOS and Android!");
#endif
  ...
  Data outData = Device::getTextureDataForText(
      text, textDef, align, imageWidth, imageHeight, hasPremultipliedAlpha);
  if (outData.isNull()) {
    return false;
  }

  Size imageSize = Size((float)imageWidth, (float)imageHeight);
  pixelFormat = backend::PixelFormatUtils::convertDataToFormat(
      outData.getBytes(), imageWidth * imageHeight * 4, PixelFormat::RGBA8888,
      pixelFormat, &outTempData, &outTempDataLen);

  ret = initWithData(outTempData, outTempDataLen, pixelFormat, imageWidth,
...
bool Texture2D::hasMipmaps() const { return _texture->hasMipmaps(); }
...
unsigned int Texture2D::getBitsPerPixelForFormat(
    backend::PixelFormat format) const {
...
void Texture2D::addSpriteFrameCapInset(SpriteFrame* spritframe,
...
const Rect& Texture2D::getSpriteFrameCapInset(
    cocos2d::SpriteFrame* spriteFrame) const {
  CCASSERT(_ninePatchInfo != nullptr,
           "Can't get the sprite frame capInset when the texture contains no "
           "9-patch info.");
...
Texture2D* Texture2D::getAlphaTexture() const { return _alphaTexture; }
...
void Texture2D::generateMipmap() {
  CCASSERT(_pixelsWide == ccNextPOT(_pixelsWide) &&
               _pixelsHigh == ccNextPOT(_pixelsHigh),
...
void Texture2D::initProgram() {
  if (_programState != nullptr) return;

  auto& pipelineDescriptor = _customCommand.getPipelineDescriptor();
  // create program state
  auto* program = backend::Program::getBuiltinProgram(
      backend::ProgramType::POSITION_TEXTURE);
  ...
  if (iter != attributes.end())
    vertexLayout->setAttribute("a_position", iter->second.location,
                               backend::VertexFormat::FLOAT2, 0, false);

  iter = attributes.find("a_texCoord");
  if (iter != attributes.end())
    vertexLayout->setAttribute("a_texCoord", iter->second.location,
                               backend::VertexFormat::FLOAT2, 2 * sizeof(float),
                               false);
  ...
  _customCommand.createVertexBuffer(4 * sizeof(float), 4,
...
void Texture2D::drawInRect(const Rect& rect, float globalZOrder) {
  ...
  _programState->setUniform(_mvpMatrixLocation, matrixMVP.m,
                            sizeof(matrixMVP.m));
