...
uint8_t computeBitsPerElement(PixelFormat textureFormat) {
  switch (textureFormat) {
    ...
    case PixelFormat::D24S8:
      ...
      // ios use MTLPixelFormatDepth32Float_Stencil8 as DepthStencil combined
      // format, its 64 bits
      return byte(8);
#else
...
void TextureBackend::updateTextureDescriptor(
...
TextureCubemapBackend::TextureCubemapBackend(
